...
public class Home extends javax.swing.JFrame {
    ...
    public Home(BigInteger idUser) {
        usuario=traerUser(idUser);
        initComponents();
    }
    
    public Usuarios traerUser(BigInteger idUser){
    ...
    private void initComponents() {
        ...
        Reclamos.setText("Solicitudes de Constancias");
        Reclamos.setColorPrimario(new java.awt.Color(105, 190, 228));
        Reclamos.setColorPrimarioHover(new java.awt.Color(213, 240, 252));
        Reclamos.setColorSecundario(new java.awt.Color(213, 240, 252));
        Reclamos.setColorSecundarioHover(new java.awt.Color(105, 190, 228));
        panelUsuarios.add(Reclamos, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 440, 250, 40));

        rSButtonGradiente2.setText("Eliminar");
        ...
        rSButtonGradiente2.setColorSecundario(new java.awt.Color(213, 240, 252));
        rSButtonGradiente2.setColorSecundarioHover(new java.awt.Color(105, 190, 228));
        rSButtonGradiente2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rSButtonGradiente2ActionPerformed(evt);
            }
        });
        panelUsuarios.add(rSButtonGradiente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 440, 130, 40));

        rSButtonGradiente3.setText("Modificar");
        rSButtonGradiente3.setColorPrimario(new java.awt.Color(105, 190, 228));
        rSButtonGradiente3.setColorPrimarioHover(new java.awt.Color(213, 240, 252));
        rSButtonGradiente3.setColorSecundario(new java.awt.Color(213, 240, 252));
        rSButtonGradiente3.setColorSecundarioHover(new java.awt.Color(105, 190, 228));
        panelUsuarios.add(rSButtonGradiente3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 440, 130, 40));

        Reclamos1.setText("Reclamos");
        Reclamos1.setColorPrimario(new java.awt.Color(105, 190, 228));
        Reclamos1.setColorPrimarioHover(new java.awt.Color(213, 240, 252));
        Reclamos1.setColorSecundario(new java.awt.Color(213, 240, 252));
        Reclamos1.setColorSecundarioHover(new java.awt.Color(105, 190, 228));
        panelUsuarios.add(Reclamos1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 440, 130, 40));
        ...
        imgBtnUsuario1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rsz_rsz_1rsz_1user_icon.png"))); // NOI18N
        background.add(imgBtnUsuario1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 10, 40, 30));
    ...
    private rsbuttongradiente.RSButtonGradiente Reclamos;
    private rsbuttongradiente.RSButtonGradiente Reclamos1;
